...
import { getEndColumn, getVisibility, getJsDocText, getJsDocTags, getDocumentationInfo } from '../../utils/ts-helpers.js'; // Assuming ts-helpers.ts will be created
    ...
    for (const declaration of classes) {
        try {
            ...
            const classNode: AstNode = {
                ...
                tags: structuredTags.length > 0 ? structuredTags : undefined,
