...
interface Config {
  ...
  tempDir: string;
  /** Python executable path for Python AST parsing. */
  ...
  jspSpringConfig: {
    ...
    jspSourcePaths: string[];
    /** Paths to scan for Web Flow XML files */
    webFlowDefinitionPaths: string[];
    /** Enable EL expression resolution to Java models */
    enableELResolution: boolean;
    /** Include tag library analysis */
    includeTagLibs: boolean;
    /** Patterns to identify Web Flow XML files */
    webFlowPatterns: string[];
  };
}
const config: Config = {
  ...
  jspSpringConfig: {
    jspSourcePaths: [
      '**/src/main/webapp/**/*.jsp',
      '**/src/main/webapp/**/*.jspx',
      '**/WebContent/**/*.jsp',
      '**/web/**/*.jsp'
    ],
    webFlowDefinitionPaths: [
      '**/src/main/webapp/WEB-INF/flows/**/*.xml',
      '**/src/main/resources/flows/**/*.xml',
      '**/flows/**/*.xml'
    ],
    enableELResolution: true,
    includeTagLibs: true,
    webFlowPatterns: [
      '**/flows/**/*.xml',
      '**/*-flow.xml',
